    ...
    <div className="flex-1 overflow-y-auto custom-scrollbar px-10 pt-8 pb-12 bg-surface-dim">
      <div className="mb-10">
        ...
        <p className="text-on-surface-variant font-body">
          Advanced analytics and competitive intelligence reports.
        </p>
      </div>
      ...
      <div className="flex items-center justify-center py-24">
        <div className="text-center space-y-4">
          ...
          <p className="text-on-surface-variant text-sm max-w-md">
            Advanced analytics including competitive radar, market trends, and AI-powered insights will be available here.
          </p>
        </div>
      </div>
    </div>
